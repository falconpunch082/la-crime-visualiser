...
import sqlite3
con = sqlite3.connect("la_crime_codes.sqlite")

# create cursor
cur = con.cursor()

# create table
cur.execute("CREATE TABLE Crime_Data_LA_CrimeCode(CrimeCode, CrimeName)")
...
# insert into table
cur.executemany("INSERT INTO Crime_Data_LA_CrimeCode VALUES(?, ?)", data)
con.commit() 