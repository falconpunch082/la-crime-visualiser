...
# [Required] PostgreSQL / pgAdmin4
    # Locally host the SQL database (crime_db) to run the Python Flask App locally
    # To build the database and table, go to: la-crime-visualiser\crimeSQL\crimeSQL_Local.sql

# [Required] Make changes appropriate to your own PostgreSQL setup here...
username = "postgres"   # Your pgAdmin4 Username
password = "1234567"    # Your pgAdmin4 Password
host = "localhost"      # Your Host Name (local default = localhost)
port = "5432"           # Your Port Number (local default = 5432)
db_name = "crime_db"    # PostgreSQL Database Name (Change this if different from crime_db)

# Final URL to connect to the PostgreSQL Database
url = f"postgresql://{username}:{password}@{host}:{port}/{db_name}"

# Create connecton to your local PostgreSQL database
